...
public interface EasyTaskService {
     ...
     * @author MoJie
     * @since 1.0  2024-10-09 10:49:25
     */
    void addComment(FlowComment flowComment);

    /**
     * 获取流程任务对象
     * @param exception 任务不存在是否抛出异常
     * @param taskId 任务ID
     * @return {@link Task}
     * @author MoJie
     * @since 1.0  2024-10-09 10:49:49
     */
    Task getFlowTask(String taskId, boolean exception);

    /**
     * 根据任务ID获取任务对象，没有则会抛出异常
     * @param taskId 任务ID
     * @return {@link Task}
     * @author MoJie
     */
     ...
     * @return {@link FlowExecutionHistory} 获取流程实例
     * @author MoJie
     * @since 1.0  2024/10/31 19:39
     */
    FlowExecutionHistory getFlowExecutionHistory(HistoricActivityInstance instance, List<Comment> commentList);

    /**
     * @param taskId 任务ID
     * @return {@link List} {@link Option} 根据任务节点获取下一节点的流程变量和当前节点的拓展参数
     * @author MoJie
     * @since 1.0  2024/11/9 16:43
     */
